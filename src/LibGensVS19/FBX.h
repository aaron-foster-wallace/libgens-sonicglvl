...
namespace LibGens {
	...
	class FBX {
		...
		public:
			...
			FbxMesh *addNodeV2(Model* model, HavokSkeletonCache* skeleton, list <LibGens::HavokAnimationCache*> animation_list, Matrix4 transform_matrix = Matrix4());
			FbxMesh *addNamedNodeV2(string name, Model* model, HavokSkeletonCache* skeleton, list <LibGens::HavokAnimationCache*> animation_list, Matrix4 transform_matrix = Matrix4());
			...
			void addHavokAnimationNamed(string name, vector<FbxNode*>& skeleton_bones, hkaSkeleton* skeleton, hkaAnimationBinding* animation_binding, hkaAnimation* animation);
